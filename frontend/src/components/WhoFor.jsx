    ...
    <section className="py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-xl text-gray-400 text-center mb-16 max-w-2xl mx-auto">
          Whether you're laying down beats, recording vocals, or perfecting the mix, RhyMerge brings your skills together.
        </p>
          ...
          {personas.map((persona, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                ...
                {/* Decorative ring */}
                <div className="absolute inset-0 w-48 h-48 rounded-full border-2 border-[#E36FFF] opacity-0 group-hover:opacity-100 transition-opacity duration-300" style={{ transform: 'scale(1.1)' }} />
              </div>
